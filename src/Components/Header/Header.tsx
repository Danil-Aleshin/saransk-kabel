...
interface propsHeader{
  setSigInWindowLog:TypeSetState<boolean>
}

const Header:React.FC<propsHeader> = memo(({ setSigInWindowLog }) => {
        ...
        <div className="container">
          <div className="header__inner">
            ...
            <div className='mobile-link-block'>
              ...
              <Link to={userAuth ? "/profile" : "#"} className="profile" onClick={()=>setSigInWindowLog(true)}>
                ...
                <span>{userInfo ? userInfo.firstName + " " + userInfo.lastName : "Войти"}</span>
              </Link>
              {screenWidth < 768 &&
                <div
